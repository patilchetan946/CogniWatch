...
# Resize the image to match screen resolution
image2 = Image.open('Background/Presentation.jpg')
...
background_label.place(x=0, y=0, relwidth=1, relheight=1)  # Resize the image to fill the entire window


l1 = tk.Label(window, text="REGISTRATION FORM", font=("Times new roman", 30, "bold"), bg="#330099", fg="yellow")
l1.place(x=120, y=50)
